      ...
      {selectedCase && (
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
          <div style={{background:"#111",border:"1px solid #cc0000",borderRadius:14,padding:28,width:480,maxHeight:"90vh",overflowY:"auto"}}>
            ...
            {selectedCase.reasons && (
              <div style={{background:"#0a0505",border:"1px solid #cc000022",borderRadius:8,padding:14,marginBottom:16}}>
                <div style={{color:"#888",fontSize:10,fontFamily:"monospace",letterSpacing:1,marginBottom:10,textAlign:"center"}}>REASON</div>
                <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,color:"#e0e0e0",fontSize:12,fontFamily:"monospace"}}>
                  {selectedCase.reasons.split(" ↓ ").map((reason, rIdx, arr) => (
                    <div key={reason} style={{textAlign:"center"}}>
                      <div style={{color:"#ff4444",fontWeight:700}}>{reason}</div>
                      {rIdx < arr.length - 1 && <div style={{color:"#555",margin:"4px 0",fontSize:14}}>↓</div>}
                    </div>
                  ))}
                </div>
              </div>
